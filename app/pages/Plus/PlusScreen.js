...
export default class PlusScreen extends React.Component {
    ...
    ADD_ROUND_COURSE_REVIEW = () => {
        //By Harshit
        Actions[ADD_ROUND_COURSE_REVIEW]()
    };
    SCORECARDEDIT = () => {
        //By Harshit
        Actions[SCORECARDEDIT]()
    };
    VOICENOTES = () => {
        //By Harshit
        Actions[VOICENOTES]()
                    ...
                    <View>
                        ...
                        <ScrollView style={{ height: window.height - 140, }}>
                            <View>
                                ...
                                <View style={{ marginRight: 10, marginLeft: 10, marginTop: 45, width: width, flexDirection: "row", alignItems: 'center', }}>
                                    ...
                                    <View style={{ marginTop: 10, height: 50, backgroundColor: '#000', width: width, flexDirection: "row", alignItems: 'center', }}>
                                        ...
                                        <TouchableOpacity onPress={this._showModal}>
                                            ...
                                            <TouchableOpacity onPress={this.HIGHLIGHTEDACHIVED}> 
                                            <Text style={{ backgroundColor:'transparent',color: "#fff", fontSize: 14, }}>
                                                Highlights</Text>
                                                </TouchableOpacity>
                                        </View>
                                        <View style={{ position: 'absolute', right: 15, justifyContent: 'center', alignItems: 'center', }}>
                                            ...
                                            starColor={'#BBAA64'}
                                            />
                                                <TouchableOpacity onPress={this.ADD_ROUND_COURSE_REVIEW}>
                                            <Text style={{ backgroundColor: 'transparent', color: "#fff", fontSize: 14, }}>
                                            Write review</Text>
                                            </TouchableOpacity>
                                        </View>
                                ...
                                <View style={{
                                    marginLeft: 10, marginRight: 10, marginTop: 15, height: 100,
                                    ...
                                    <View style={{ marginLeft: 5, justifyContent: 'center', alignItems: 'center', }}>
                                        <Image style={{ width: 65, height: 65, borderRadius: 65, }}
                                            source={require('../../Images/DashImages/profile.png')} />
                                        <Text style={{backgroundColor:'transparent', color: "#000", fontSize: 14, }}>
                                            name</Text>
                                    </View>
                                    <TouchableOpacity>
                                    <View style={{ justifyContent: 'center', alignItems: 'center', }}>
                                        <Image style={{ width: 65, height: 65, borderRadius: 65, }}
                                            source={require('../../Images/DashImages/plusButton.png')} />
                                        <Text style={{backgroundColor:'transparent', color: "transparent", fontSize: 14, }}>
                                            name</Text>
                                    </View>
                                    </TouchableOpacity>
                                    <View style={{ justifyContent: 'center', alignItems: 'center', }}>
                                ...
                                <View style={{ marginTop: 15, width: width, flexDirection: "row", 
                                ...
                                <TouchableOpacity>
                                    <View style={[styles.rightButton, this.props.second]}>
                                        <Text style={styles.text}>18 holes</Text>
                                    </View>
                                </TouchableOpacity>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity  onPress={this.SCORECARDEDIT}
                                        ...
                                        <TouchableOpacity onPress={this.PHOTOS}
                                        style={{ height: 195, width: 195, borderRadius: 5 }}  >
                                            <Image
                                                source={cardPic}
                                                resizeMode="contain"
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={this.VOICENOTES}
                                        style={{ height: 195, width: 195, borderRadius: 5 }}  >
                                            <Image
                                                source={cardPic}
                                                resizeMode="contain"
                                ...
                                <View style={{
                                    marginLeft: 15, marginRight: 15, marginTop: 40, height: 150,
                                    backgroundColor: '#fff', borderRadius: 10,
                                    alignItems: 'center',
                                }}>

                                    <View style={{ height: 45, width: width, flexDirection: "row", alignItems: 'center', }}>

                                        <View style={{ marginLeft: 20, flexDirection: "row", }}>
                                            <Image style={{ width: 30, height: 30, }}
                                                source={require('../../Images/DashImages/profile.png')} />
                                            <Text style={{ backgroundColor:'transparent',marginLeft: 10, fontWeight: 'bold', color: "#000", fontSize: 18, }}>
                                                Instagram</Text>
                                        </View>
