...
export default class HandicapAndstatistics extends React.Component  {
  constructor(props) {
    super(props);
            ...
            <ScrollView>
                ...
                <View >
                    <View style={styles.profileheader}>
                        <Text style={styles.profilesettings}> Golf Settings - Handicap And statistics </Text>
                    </View>
                    <View>
                    ...
                    <Text style={styles.detailtext}> Handicap </Text>

                        <View style={{flexDirection:'row',}}>
                            <Text style={{marginTop:10,marginLeft:35}}> Your handicap </Text>
                                <View style={{flex:1,alignSelf:'flex-end',}}>
                                    <Switch
                                        onValueChange={(value) => this.setState({falseSwitchIsOn: value})}
                    ...
                    <View style={{flexDirection:'column',marginTop:10,marginBottom:10}}>
                        <View style={{flexDirection:'row'}}>
                            <Text style={{marginTop:10,marginLeft:35}}> Tour pro</Text>
                                <View style={{flex:1,alignSelf:'flex-end',}}>
                                    <Switch
                                        onValueChange={(value) => this.setState({falseSwitchIsOn: value})}
                                        style={{ flex:1,alignSelf:'flex-end',marginTop:10,marginBottom:10,marginRight:20}}
                                        value={this.state.falseSwitchIsOn}
                                        onTintColor ='#BBAA64'
                                        tintColor='#fffaf0'
                                    />
                        ...
                        <View style={{flexDirection:'row',marginTop:10,marginBottom:10}}>
                            <Text style={{marginTop:10,marginLeft:35}}> Teaching pro </Text>
                                <View style={{flex:1,alignSelf:'flex-end',}}>
                                    <Switch
                                        onValueChange={(value) => this.setState({falseSwitchIsOn: value})}
                                        style={{ flex:1,alignSelf:'flex-end',marginTop:10,marginBottom:10,marginRight:20}}
                        ...
                        <View style={{flexDirection:'row',marginTop:10,marginBottom:10}}>
                            <Text style={{marginTop:10,marginLeft:35}}> Caddy </Text>
                                <View style={{flex:1,alignSelf:'flex-end',}}>
                                    <Switch
                                        onValueChange={(value) => this.setState({falseSwitchIsOn: value})}
                                        style={{ flex:1,alignSelf:'flex-end',marginTop:10,marginBottom:10,marginRight:20}}
                            ...
                            <View style={{flexDirection:'row',marginTop:25,marginBottom:10}}>
                                <Text style={{marginLeft:35}}>No handicap</Text>
                                    <View style={{flex:1,alignSelf:'flex-end',}}>
                                        <Switch
                                            onValueChange={(value) => this.setState({falseSwitchIsOn: value})}
                                            style={{ flex:1,alignSelf:'flex-end',marginTop:5,marginBottom:10,marginTop:-5,marginRight:20}}
