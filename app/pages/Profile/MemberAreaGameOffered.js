...
import MyPost from './MemberAreaGameOfferedTab/MyPost';
import Filter from './MemberAreaGameOfferedTab/Filter';
import Saved from './MemberAreaGameOfferedTab/Saved';
...
export default class MemberAreaGameOffered extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    MEMBERS_AREA_OFFER_GAME = () => {
        //By Harshit
        Actions[MEMBERS_AREA_OFFER_GAME]()
    };
                      ...
                      <TouchableOpacity onPress={this.MEMBERS_SECTION_PAGE2}>
                        <Image style={styles.leftbuttonwhite} source={leftbutton_white} />
                            ...
                            <View style={styles.flex_column}>
                                ...
                                <Text style={styles.homeClub}> {gameoffered} </Text>
                            </View>
                             <View style={{alignItems:'flex-end',marginTop:30,marginRight:20}}>
                             <TouchableOpacity onPress={this.MEMBERS_AREA_OFFER_GAME}>
