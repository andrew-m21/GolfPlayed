...
//MembersArea1
export default class MemberAreaRequestGame extends Component {
  constructor() {
    super();
    this.state = {
        ...
        <Image style={styles.coverImage} source={backgroundimage} >
          <View>
            <View style={styles.headerView}>
              <TouchableOpacity onPress={this.MEMBERS_AREA_GAME_REQUESTED}>
                <Image style={styles.leftbuttonwhite} source={leftbutton_white} />
              </TouchableOpacity>
              <Text style={styles.memberSection}> Request Game </Text>
            </View>
