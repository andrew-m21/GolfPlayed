        ...
        return (
            <View style={styles.container}>
               ...
               <View style={styles.innerView}> 
                ...
                <Text style={{margin:10,color:'white',fontSize:20,margin:10}}> Members area 1 </Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={this.MEMBERS_SECTION_PAGE2}>
                <Text style={{margin:10,color:'white',fontSize:20,margin:10}}> members section page 2</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={this.MEMBERS_AREA_NEWS_FEEDS}>
                <Text style={{margin:10,color:'white',fontSize:20,margin:10}}>  Member News feeds </Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={this.CREATE_NEWS_FEED_POST}>
                <Text style={{margin:10,color:'white',fontSize:20,margin:10}}> CREATE NEWS FEED POST</Text>
                </TouchableOpacity>
