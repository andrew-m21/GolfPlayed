    ...
    return (
     ...
     <View style={{marginBottom:25}}>
       ...
       <View style={{marginLeft:25,top:10}}>
         <TouchableOpacity><Text style={styles.leftText}>Recent activities</Text></TouchableOpacity>
         <TouchableOpacity><Text style={styles.leftText}>Courses</Text></TouchableOpacity>
         <TouchableOpacity><Text style={styles.leftText}>Members</Text></TouchableOpacity>
         <TouchableOpacity><Text style={styles.leftText}>Database</Text></TouchableOpacity>
      </View>
      <View style={{height:1.5, backgroundColor: "rgba(187, 170, 100, 0.5)", marginLeft:5, marginRight: 5,top:20}}>
        ...
        <View style={{marginLeft:25,top:20}}>
         <TouchableOpacity><Text style={styles.leftText}>Recent serach results</Text></TouchableOpacity>
