...
const closeIcon = require('../../../Images/DashImages/buttons/close.png')

//MembersArea1
export default class ExplorerCreateNewsFeedpost extends Component {
  constructor() {
    super();
    ...
    EXPLORER_TAG_YOUR_BUDDIES = () => {
      //By harshit
      Actions[EXPLORER_TAG_YOUR_BUDDIES]()
    };
  ...
  renderListItem(rowData, rowId) {
        ...
        return(
          <View>
            <TouchableOpacity style={[styles.listItem, styles.lastItemPadding]}>
              ...
              <View style={styles.badgeContainer}><Image style={styles.rightArrow} source={closeIcon}/></View>
            </TouchableOpacity>
    ...
    render() {
        return (
          <Image style={{height:window.height,width:window.width}} source={backgroundimage} >
            <View style={styles.container}>
               <ScrollView>
                  ...
                  <ListView showsVerticalScrollIndicator={false} 
                    ...
                    <TouchableOpacity onPress={this.EXPLORER_TAG_YOUR_BUDDIES}>
