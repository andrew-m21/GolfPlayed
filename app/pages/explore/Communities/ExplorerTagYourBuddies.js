...
const plusButton = require("../../../Images/DashImages/plusButton.png")

//MembersArea1
export default class ExplorerTagYourBuddies extends Component {
    constructor() {
        super();
        ...
        return(
          <View>
            <TouchableOpacity style={[styles.listItem, styles.lastItemPadding]}>
              ...
              <View style={styles.badgeContainer}><Image style={styles.rightArrow} source={plusButton}/></View>
            </TouchableOpacity>
